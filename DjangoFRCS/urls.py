...
urlpatterns = [
    ...
    path('pit-detail/<int:stat_id>/', scout_views.PitDetail, name = 'pitdata-view'),
    ...
    path('archive/<int:id>', scout_views.archiveWarning , name='archive-view'),
    path('delete/<int:id>', scout_views.downloadGameData , name='delete-view'),
